...
const styles = StyleSheet.create({
  ...
  scroll: { paddingHorizontal: SPACING[5], paddingTop: SPACING[2], paddingBottom: SPACING[10] },
  heroIcon: {
    width: 60,
    height: 60,
    borderRadius: 30,
  ...
  emergencyLabel: { fontFamily: FONTS.heavy, fontSize: TYPE_SIZE.body, color: '#fff' },
  helplineRow: { flexDirection: 'row', gap: SPACING[2], marginTop: SPACING[2] },
  helplineBtn: {
    flex: 1,
    height: 52,
