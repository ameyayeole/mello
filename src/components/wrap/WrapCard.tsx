...
const styles = StyleSheet.create({
  ...
  mosaic: { flexDirection: 'row', gap: 6, height: 200 },
  hero: { flex: 2, borderRadius: 16, backgroundColor: COLORS.primaryTint },
  sideColumn: { flex: 1, gap: 6 },
  sideCell: { flex: 1, borderRadius: 16, overflow: 'hidden' },
  ...
  moreText: { fontFamily: FONTS.heavy, fontSize: 18, color: '#fff' },
