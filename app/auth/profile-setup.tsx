...
const styles = StyleSheet.create({
  ...
  scroll: { padding: SPACING[5], paddingTop: SPACING[6], paddingBottom: SPACING[5] },
  title: {
  ...
  dobRow: { flexDirection: 'row', gap: SPACING[2.5] },
  dobInput: {
    flex: 1,
    textAlign: 'center',
